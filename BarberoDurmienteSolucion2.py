...
class Barberia:
    ...
    def __init__(self, barbero, cantidadDeSillas):
        ...
        self.semaforoClientes = threading.Semaphore(cantidadDeSillas)
    ...
    def entraClienteABarberia(self, cliente):
        ...
        if self.semaforoClientes.acquire(blocking=False):
...
class barbero:
    ...
    dormirBarbero = threading.Semaphore(0)
